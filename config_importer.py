...
CONFIG_SCHEMA = {
    ...
    "STOP_LOSS_COOLDOWN_MINUTES": {"type": int, "min": 0, "max": 10080},
    "TAKE_PROFIT_COOLDOWN_MINUTES": {"type": int, "min": 0, "max": 10080},
    ...
    "MACRO_REGIME_HYSTERESIS_CYCLES": {"type": int, "min": 1, "max": 12},
    "MACRO_BTC_DOM_TREND_WINDOW": {"type": int, "min": 1, "max": 24},
    ...
    "BACKTEST_BOOTSTRAP_SAMPLES": {"type": int, "min": 0, "max": 10000},
    "BACKTEST_OOS_FRACTION": {"type": float, "min": 0.05, "max": 0.80},
    ...
    "ORDER_CLIENT_ID_ENABLED": {"type": bool},
    "ORDER_CLIENT_ID_PARAM": {"type": str, "max_len": 80},
    ...
    "AI_INVALID_RESPONSE_RULES_FALLBACK": {"type": bool},
    "AI_MAX_OUTPUT_TOKENS": {"type": int, "min": 64, "max": 4096},
    "AI_PROVIDER_TIMEOUT_SECONDS": {"type": int, "min": 3, "max": 120},
    "AI_MAX_POSITION_SIZE_MULTIPLIER": {"type": float, "min": 0.1, "max": 3.0},
    "ADD_TO_WINNER_ENABLED": {"type": bool},
    "ADVANCED_EDGE_ENABLED": {"type": bool},
    "ADVANCED_EDGE_MIN_RELIABILITY": {"type": float, "min": 0.0, "max": 1.0},
    "ADVANCED_EDGE_MIN_TRADES": {"type": int, "min": 1, "max": 1000},
    ...
    "ALERT_ORDER_FAILURES": {"type": bool},
    "ALERT_MISMATCHES": {"type": bool},
